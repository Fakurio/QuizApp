...
export type CreateSoloGameMutation = {
  __typename?: "Mutation";
  createSoloGame?: boolean | null;
};
...
export type SendGameSummaryMutation = {
  __typename?: "Mutation";
  sendGameSummary?: boolean | null;
};
...
export type SeekGameMutation = {
  __typename?: "Mutation";
  seekGame?: boolean | null;
};
...
export type CancelSeekingGameMutation = {
  __typename?: "Mutation";
  cancelSeekingGame?: boolean | null;
};
...
export type GetDifficultiesQuery = {
  __typename?: "Query";
  difficulties: Array<{ __typename?: "Difficulty"; id: number; name: string }>;
};
...
export type GetUserGamesHistoryQuery = {
  __typename?: "Query";
  getUserGamesHistory: {
    __typename?: "History";
    totalCount: number;
...
export type OnNewQuestionSubscription = {
  __typename?: "Subscription";
  newQuestion: {
    __typename?: "Question";
    id: number;
...
export type OnOpponentFoundSubscription = {
  __typename?: "Subscription";
  opponentFound: { __typename?: "OpponentFound"; gameCode: string };
};
...
export type OnOpponentAnswerSubscription = {
  __typename?: "Subscription";
  opponentAnswer: { __typename?: "OpponentAnswer"; isCorrect: boolean };
};
  ...
  definitions: [
    {
      ...
      operation: "mutation",
      name: { kind: "Name", value: "StopGame" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "gameCode" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
} as unknown as DocumentNode<StopGameMutation, StopGameMutationVariables>;
...
export const EndRoundDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "endRound" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<EndRoundMutation, EndRoundMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "createSoloGame" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const SendGameSummaryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "sendGameSummary" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "playerAnswers" },
          },
          type: {
            kind: "NonNullType",
            type: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "playerScore" },
          },
          type: {
            kind: "NonNullType",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "seekGame" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "seekGameInput" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
} as unknown as DocumentNode<SeekGameMutation, SeekGameMutationVariables>;
export const CancelSeekingGameDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "cancelSeekingGame" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetDifficulties" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
export const GetUserGamesHistoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getUserGamesHistory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "questionName" },
                            },
                            {
                              kind: "Field",
                              name: {
                                kind: "Name",
                                value: "isCorrectlyAnswered",
                              },
                            },
                          ],
                        },
...
>;
export const OnNewQuestionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "OnNewQuestion" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "newQuestion" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "gameCode" },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "name" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "incorrect" },
                      },
                    ],
                  },
                },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "questionAmount" },
                },
              ],
            },
          },
...
>;
export const OnOpponentFoundDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "OnOpponentFound" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "opponentFound" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "playerID" },
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "gameCode" } },
              ],
            },
          },
        ],
...
>;
export const OnOpponentAnswerDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "OnOpponentAnswer" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "opponentAnswer" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "gameCode" },
