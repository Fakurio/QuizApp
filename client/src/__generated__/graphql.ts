...
export type Mutation = {
  ...
  playerDisconnected?: Maybe<Scalars['Boolean']['output']>;
  seekGame?: Maybe<Scalars['Boolean']['output']>;
  sendGameSummary: HistoryInput;
...
export type MutationPlayerDisconnectedArgs = {
  playerID: Scalars['Int']['input'];
};
...
export type OpponentDisconnected = {
  __typename?: 'OpponentDisconnected';
  gameCode: Scalars['String']['output'];
};
...
export type SubscriptionOpponentDisconnectedArgs = {
  gameCode: Scalars['String']['input'];
};
...
export type SendGameSummaryMutation = { __typename?: 'Mutation', sendGameSummary: { __typename?: 'HistoryInput', id: number, categoryName: string, opponentName?: string | null, questions: Array<{ __typename?: 'HistoryQuestion', questionName: string, isCorrectlyAnswered: boolean }> } };
...
export type PlayerDisconnectedMutationVariables = Exact<{
  playerID: Scalars['Int']['input'];
}>;


export type PlayerDisconnectedMutation = { __typename?: 'Mutation', playerDisconnected?: boolean | null };
...
export type OnOpponentDisconnectedSubscriptionVariables = Exact<{
  gameCode: Scalars['String']['input'];
}>;


export type OnOpponentDisconnectedSubscription = { __typename?: 'Subscription', opponentDisconnected: { __typename?: 'OpponentDisconnected', gameCode: string } };
...
export const PlayerDisconnectedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"playerDisconnected"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"playerID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"playerDisconnected"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"playerID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"playerID"}}}]}]}}]} as unknown as DocumentNode<PlayerDisconnectedMutation, PlayerDisconnectedMutationVariables>;
...
export const OnOpponentDisconnectedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"OnOpponentDisconnected"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameCode"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"opponentDisconnected"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameCode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameCode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gameCode"}}]}}]}}]} as unknown as DocumentNode<OnOpponentDisconnectedSubscription, OnOpponentDisconnectedSubscriptionVariables>;